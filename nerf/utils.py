...
def get_rays(poses, intrinsics, H, W, N=-1, error_map=None, camera_model='pinhole', MAX_TOUCH_ANGLE = 72.5):
    ...
    print("Printing camera model....", camera_model)
    print("INTRINICS")
    print(H,W)
    ...
    if camera_model == "pinhole":
        print("Using the PINHOLE cameras for the COLOR and the DEPTH images....")
        ...
        print("Printing camera model inside the elif statement == touch:     ", camera_model)
        if os.path.exists('./data/touch_rays.pt'):
            ...
            print("Found the table.npz file and so exiting the code......")
            #sys.exit()
